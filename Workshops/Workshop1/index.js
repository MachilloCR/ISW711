...
const db = mongoose.connect("mongodb+srv://Username:<password>@cluster0.zlsypte.mongodb.net/?retryWrites=true&w=majority");
...
app.get('/teams/team', (req, res) => {
    ...
    if (req.query && req.query.id) {
        ...
        TeamModel.findById(req.query.id, function (err, team) {
            if (err) {
                res.status(404);
